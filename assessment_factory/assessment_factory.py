...
class AssessmentFactoryXBlock(XBlock):
    ...
    def student_view(self, context=None):
        ...
        """
        html = self.resource_string("static/html/assessment_factory.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("static/css/assessment_factory.css"))
        frag.add_javascript(self.resource_string("static/js/src/assessment_factory.js"))
        frag.initialize_js('AssessmentFactoryXBlock')
        return frag
